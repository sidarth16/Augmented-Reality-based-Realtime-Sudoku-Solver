...
def sudoku_main(img , corners , required_num_in_sol=""):
    ...
    sudoku.solve(img_cropped_sudoku, approximate=0.95 , required_num_in_sol= required_num_in_sol)
    ...
    return img_cropped_sudoku_copy ,sudoku_crop_thresh , extracted_digits ,predicted_unsolved_grid, img_cropped_sudoku , img_final , sudoku
